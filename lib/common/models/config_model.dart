import 'dart:convert';
import 'package:seohost/feature/web_landing/model/web_landing_model.dart';
...
class ConfigContent {
  ...
  ConfigContent.fromJson(Map<String, dynamic> json) {
    ...
    businessPages = json["business_pages"] == null ? [] : List<BusinessPage>.from(json["business_pages"]!.map((x) => BusinessPage.fromJson(x)));
