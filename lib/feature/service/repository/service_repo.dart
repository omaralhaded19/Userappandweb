import 'package:seohost/common/enums/enums.dart';
import 'package:seohost/common/models/api_response_model.dart';
import 'package:seohost/common/repo/data_sync_repo.dart';
...
class ServiceRepo extends DataSyncRepo {
  ...
  Future<Response> getServiceListBasedOnSubCategory({
    ...
    return await apiClient.getData(
      '${AppConstants.serviceBasedOnSubcategory}$subCategoryID?limit=150&offset=$offset${directOnly ? '&direct=1' : ''}',
    );
  }
