import 'package:seohost/api/local/cache_response.dart';
import 'package:seohost/common/models/api_response_model.dart';
import 'package:seohost/feature/service/model/recommendation_search_model.dart';
import 'package:seohost/helper/data_sync_helper.dart';
...
class ServiceController extends GetxController implements GetxService {
  ...
  Future<List<Service>> getDirectCategoryServiceList(String categoryID) async {
    ...
    if (response.statusCode == 200 &&
      ...
      return ServiceModel.fromJson(response.body).content?.serviceList ?? [];
    }
